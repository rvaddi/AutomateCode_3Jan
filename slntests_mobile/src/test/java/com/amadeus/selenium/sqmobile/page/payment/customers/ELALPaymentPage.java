...
public class ELALPaymentPage extends CommonPaymentPage implements IPayment{
  ...
  protected final static By LOC_BT_EXTERNAL_PAYMENT_PAY = By.id("Continuebtn");

  public ELALPaymentPage(SeleniumSEPTest test) throws Exception {
    super(test);
  }
  ...
  public ConfirmationPage clickContinue() throws Exception {
    ...
    return PageFactory.getPageObject(ELALConfirmationPage.class);
  }


  /**
   * Clicks on continue payment button on confirmation page , then Clicks on Pay Button on External Page
   * @return ELALConfirmation Page
   * @throws Exception
   */
  public ConfirmationPage implementationExternalPayment() throws Exception {
    ...
    ClickUtils.clickButtonOrFail(getTest(), LOC_BT_EXTERNAL_PAYMENT_PAY, "External Payment : PayNow Button not dispalyed");
    reporter.reportPassed("External Payment", "Pay Button Clicked Successfully");
    waitForOverlayLoading(60);
