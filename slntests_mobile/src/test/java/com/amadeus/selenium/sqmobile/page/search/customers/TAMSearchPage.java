...
public class TAMSearchPage extends SearchPage{
  ...
  String pageName = "TAMSearch Page";


  public TAMSearchPage(SeleniumSEPTest test) throws Exception {
    super(test);
  }
  ...
  public void selectPAXCountAndCabin() throws IOException {
	...
	if((!"".equalsIgnoreCase(getValue("Nb Infants")))){
		System.out.println("Infant NO ::: "+getValue("Nb Infants").trim());
		FillUtils.selectByValue(getTest(), LOC_LS_SEARCHPAGE_INFANT_COUNT, getValue("Nb Infants").trim());
	}
  }
}
