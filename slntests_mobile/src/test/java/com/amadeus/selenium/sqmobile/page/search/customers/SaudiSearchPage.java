...
public class SaudiSearchPage extends SearchPage{
  ...
  String pageName = "Saudi Page";


  public SaudiSearchPage(SeleniumSEPTest test) throws Exception {
    super(test);
    if(! WaitUtils.waitForElementPresent(getTest(), LOC_LS_SEARCHPAGE_CABINCLASS, 30)){
      reporter.fail("This is not SaudiSearch Page");
    }else{
      reporter.reportPassed("SaudiSearch Page", "In SaudiSearch Page");
    }
  }
