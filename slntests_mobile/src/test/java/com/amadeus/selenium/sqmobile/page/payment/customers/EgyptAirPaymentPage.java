...
/**
 * AirEgypt Payment page
 * @author vbalasubramanian
 *
 */
public class EgyptAirPaymentPage extends CommonPaymentPage implements IPayment{
  ...
  public EgyptAirPaymentPage(SeleniumSEPTest test) throws Exception {
    super(test);
    if(! WaitUtils.waitForElementPresent(getTest(), LOC_CB_AGREE_CHECKBOX, 30)){
      reporter.fail("This is no EgyptAirPayment Page");
    }else{
      reporter.reportPassed("EgyptAirPayment Page", "In EgyptAirPayment Page");
    }
  }
  /**
