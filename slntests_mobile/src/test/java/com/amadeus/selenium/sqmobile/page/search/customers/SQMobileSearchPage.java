...
public class SQMobileSearchPage extends SearchPage{
  ...
  String pageName = "SQMobileSearch Page";


  public SQMobileSearchPage(SeleniumSEPTest test) throws Exception {
    super(test);
  }
  ...
  public void fillSearchDetailsForCalendarUI() throws Exception{
    super.fillSearchDetailsForCalendarUI();
  }
